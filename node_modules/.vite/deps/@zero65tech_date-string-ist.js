...
// node_modules/@zero65tech/date-string-ist/src/index.js
var require_src = __commonJS({
  "node_modules/@zero65tech/date-string-ist/src/index.js"(exports) {
    var HOUR = 60 * 60 * 1e3;
    var DAY = 24 * HOUR;
    exports.from = (date) => {
    ...
    exports.shift = (dateStr, days) => {
      if (!days)
        return dateStr;
      let date = /* @__PURE__ */ new Date(dateStr + " GMT+530");
      return exports.from(date.getTime() + days * DAY);
    };
    exports.getDuration = (startDate, endDate) => {
      let dtStart = (startDate ? /* @__PURE__ */ new Date(startDate + " GMT+530") : /* @__PURE__ */ new Date()).getTime() + 5.5 * HOUR;
      let dtEnd = (endDate ? /* @__PURE__ */ new Date(endDate + " GMT+530") : /* @__PURE__ */ new Date()).getTime() + 5.5 * HOUR;
      return Math.floor(dtEnd / DAY) - Math.floor(dtStart / DAY);
    };
    exports.getWeekStart = (dateStr) => {
      let date = /* @__PURE__ */ new Date(dateStr + " GMT");
...
//# sourceMappingURL=@zero65tech_date-string-ist.js.map
